...
describe('MerkleMountainRange', (accounts) => {
  ...
  before(async () => {
    ...
    // myLibrary = await deployContract(wallet, MMR, []);
  ...
  context('Test pure functions', async () => {
    describe.skip('getChildren()', async () => {
    ...
    describe.skip('getPeakIndexes()', async () => {
    ...
    describe.skip('hashBranch()', async () => {
    ...
    describe.skip('peakBagging()', async () => {
    ...
    describe.skip('mountainHeight()', async () => {
  ...
  context('Gas usage test', async () => {
    ...
    it.skip(`inserted ${count} items to the tree`, async () => {
      ...
      let tx = await mmrWrapper.verifyProof('0x2dee5b87a481a9105cb4b2db212a1d8031d65e9e6e68dc5859bef5e0fdd934b2',
      7,
      1,
  ...
  context('Verify mmr proof', async () => {
    describe('inclusionProof()', async () => {
      it.skip('should return pass true when it receives a valid merkle proof (1-7)', async () => {
        // bytes32 root,
        // uint256 width,
        // uint256 index,
        // bytes memory value,
        ...
        expect(await mmrLib.verifyProof(
      ...
      it.skip('should return pass true when it receives a valid merkle proof (7000-10000)', async () => {
        // bytes32 root,
        // uint256 width,
        // uint256 index,
        // bytes memory value,
      ...
      it('should return pass true when it receives a valid merkle proof (71-101)', async () => {
        ...
        (await mmrLib.inclusionProof(
          ...
          '0x210a5e2f6af8c5b9cecb4a98db7d3fd461c73c96ce7d2c47d55707d21a2995ad',
          [
