...
contract AccountIdTest is DSTest {
    ...
    function testDeriveSubstrateAddress() public {
        bytes32 r = AccountId.deriveSubstrateAddress(0x6D6F646C64612f6272696e670000000000000000);
    ...
    function testDeriveEthereumAddressFromDvmAccountId() public {
        address e = AccountId.deriveEthereumAddressFromDvm(bytes32(0x64766d3a000000000000006be02d1d3665660d22ff9624b7be0551ee1ac91bd2));
