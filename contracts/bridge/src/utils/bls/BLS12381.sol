...
library B12_381Lib {
    ...
    uint8 constant G1_ADD = 0x0A;
    uint8 constant G1_MUL = 0x0B;
    uint8 constant G1_MULTI_EXP = 0x0C;
    uint8 constant G2_ADD = 0x0D;
    uint8 constant G2_MUL = 0x0E;
    uint8 constant G2_MULTI_EXP = 0x0F;
    uint8 constant PAIRING = 0x10;
