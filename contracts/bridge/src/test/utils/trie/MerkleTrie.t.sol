...
import "../../test.sol";
import "../../hevm.sol";
import "../../../utils/trie/MerkleTrie.sol";

contract MerkleTrieTest is DSTest {
    ...
    function test_get_validProof1_succeeds() external {
        ...
        assertEq0(val, MerkleTrie.get(key, proof, root));
    }
    ...
    function testFail_get_nonexistentKey1_reverts() external pure {
        bytes32 root = 0xd582f99275e227a1cf4284899e5ff06ee56da8859be71b553397c69151bc942f;
        bytes memory key = hex"6b657932";
        bytes[] memory proof = new bytes[](3);
        proof[0] = hex"e68416b65793a03101b4447781f1e6c51ce76c709274fc80bd064f3a58ff981b6015348a826386";
    ...
    function testFail_get_nonexistentKey2_reverts() external pure {
        bytes32 root = 0xd582f99275e227a1cf4284899e5ff06ee56da8859be71b553397c69151bc942f;
    ...
    function testFail_get_wrongKeyProof_reverts() external pure {
    ...
    function testFail_get_corruptedProof_reverts() external pure {
        bytes32 root = 0x2858eebfa9d96c8a9e6a0cae9d86ec9189127110f132d63f07d3544c2a75a696;
        bytes memory key = hex"6b6579326262";
    ...
    function testFail_get_invalidDataRemainder_reverts() external pure {
    ...
    function testFail_get_invalidInternalNodeHash_reverts() external pure {
    ...
    function testFail_get_zeroBranchValueLength_reverts() external pure {
    ...
    function testFail_get_zeroLengthKey_reverts() external pure {
    ...
    function testFail_get_smallerPathThanKey1_reverts() external pure {
    ...
    function testFail_get_smallerPathThanKey2_reverts() external pure {
    ...
    function testFail_get_extraProofElements_reverts() external pure {
        bytes32 root = 0x278c88eb59beba4f8b94f940c41614bb0dd80c305859ebffcd6ce07c93ca3749;
        bytes memory key = hex"aa";
        ...
        )
    {
        ...
        return abi.decode(hevm.ffi(cmds), (bytes32, bytes, bytes, bytes[]));
    }
    ...
    function testFuzz_get_validProofs_succeeds(bytes4) external {
        ...
        (bytes32 root, bytes memory key, bytes memory val, bytes[] memory proof) = getMerkleTrieFuzzCase("valid");
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_invalidRoot_reverts(bytes4) external {
        // Get a random test case with a valid trie / proof
        (bytes32 root, bytes memory key, , bytes[] memory proof) = getMerkleTrieFuzzCase(
            "valid"
        );
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_extraProofElements_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_invalidLargeInternalHash_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_invalidInternalNodeHash_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_corruptedProof_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_invalidDataRemainder_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_prefixedValidKey_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_emptyKey_reverts(bytes4) external {
    ...
    /// @notice The `bytes4` parameter is to enable parallel fuzz runs; it is ignored.
    function testFailFuzz_get_partialProof_reverts(bytes4) external {
