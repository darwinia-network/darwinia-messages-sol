...
ArbitrumSerialLaneVerifier=$(load_taddr "ArbitrumSerialLaneVerifier")
...
ARBITRUMSERIALLANEVERIFIER_LANES_OUT=$(seth call "$ArbitrumSerialLaneVerifier" 'lanes(uint)(address)' $OUTLANE_ID --chain $TARGET_CHAIN)
ARBITRUMSERIALLANEVERIFIER_LANES_IN=$(seth call "$ArbitrumSerialLaneVerifier" 'lanes(uint)(address)' $INLANE_ID --chain $TARGET_CHAIN)
check  "ARBITRUMSERIALLANEVERIFIER_LANES_OUT"  "SerialOutboundLane"
check  "ARBITRUMSERIALLANEVERIFIER_LANES_IN"   "SerialInboundLane"
