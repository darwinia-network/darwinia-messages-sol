...
hevm flatten --source-file src/proxy/truth/BSCLightClientProxy.sol         --json-file out/dapp.sol.json > flat/BSCLightClientProxy.f.sol
...
hevm flatten --source-file src/proxy/truth/DarwiniaLightClientProxy.sol    --json-file out/dapp.sol.json > flat/DarwiniaLightClientProxy.f.sol
hevm flatten --source-file src/proxy/truth/EthereumExecutionLayerProxy.sol --json-file out/dapp.sol.json > flat/EthereumExecutionLayerProxy.f.sol
