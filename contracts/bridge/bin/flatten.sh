...
hevm flatten --source-file src/truth/bsc/BBSCSerialLaneVerifier.sol              --json-file out/dapp.sol.json > flat/BBSCSerialLaneVerifier.f.sol
...
hevm flatten --source-file src/truth/eth/EthereumSerialVerifier.sol              --json-file out/dapp.sol.json > flat/EthereumSerialVerifier.f.sol
