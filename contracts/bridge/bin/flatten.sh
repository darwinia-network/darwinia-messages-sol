...
hevm flatten --source-file src/proxy/message/MessageGateway.sol                  --json-file out/dapp.sol.json > flat/MessageGateway.f.sol
...
hevm flatten --source-file src/proxy/message/MessageGatewayProxy.sol             --json-file out/dapp.sol.json > flat/MessageGatewayProxy.f.sol
